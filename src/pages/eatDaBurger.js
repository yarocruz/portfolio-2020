    ...
    return (
        <div className="container text-gray-900 mx-auto mx-10 my-10">
            <div className="page p-5">
                ...
                <img className="lg:max-w-3xl max-w-full mb-5 shadow" src={burgerPic} alt="screenshot of eat da burger applications" />
            ...
            that I've deployed. It was also my first deep dive into SQL and relational databases.</p>
                ...
                <Link to="/weatherDashboard" className="shadow bg-gray-100 hover:bg-gray-300 focus:shadow-outline focus:outline-none text-gray-600 hover:text-gray-800 text-sm py-2 px-4 rounded">{`See Next Project ${String.fromCharCode(8594)}`}</Link>
            </div>
        </div>
    )
}
