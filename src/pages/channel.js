...
import channelApp from "../images/channel-screenshot.png";
  ...
  <div className="container text-gray-900 mx-auto mx-10 my-10">
    <div className="page p-5">
      <div className="flex items-center mb-5">
        <h1 className="secondary-heading pr-5">Channel - RSS Reader App</h1>
        <div className="flex">
          <a href="https://github.com/yarocruz/channel">
          ...
          <a href="https://yarocruz.github.io/channel/" target="_blank" rel="noopener noreferrer" className="ml-3">
      ...
      <img className="lg:max-w-3xl max-w-full mb-5 shadow" src={channelApp} alt="screenshot of channel rss app" />

      <p className="max-w-3xl my-5">Channel is an RSS Reader Web App built with React.
        The project is currently in stage 0.8.9, but my aim is to make an RSS reader
        that has similar features like Feedly, Google Reader(RIP), and other popular RSS readers.
      </p>

      <h1 className="secondary-heading pr-5">Technologies</h1>

      <p className="max-w-3xl my-5">Project bootstrapped with create-react-app. At the moment considering Chakra UI.</p>
