  ...
  <div className="container text-gray-900 mx-auto mx-10 my-10">
    <div className="page p-5">
      <div className="flex items-center mb-5">
        <h1 className="secondary-heading pr-5 text-blue-900">Blog</h1>
        <div className="flex">
          <a href="https://github.com/yarocruz/yarocruz.github.io/tree/v2">
          ...
          <a href="https://yarocruz.netlify.app/" target="_blank" rel="noopener noreferrer" className="ml-3">
      ...
      <img className="lg:max-w-3xl max-w-full mb-5 shadow" src={blog} alt="screenshot of note taker applications" />

      <p className="max-w-3xl my-5">This is my blog. There are many like it. But this one is mine.</p>

      <h1 className="secondary-heading pr-5 text-blue-900">Technologies</h1>

      <p className="max-w-3xl my-5">This is a blog I've been maintaining since 2017. I've originally built it with Jekyll,
        but last year I revamped its look and switched it to Eleventy</p>

      <p className="max-w-3xl my-5">No big CMS. Just type in some ideas in Markdown file, commit, and push. Blogging like hacker.</p>
      ...
      <Link to="/rpsls" className="shadow bg-gray-100 hover:bg-gray-300 focus:shadow-outline focus:outline-none text-gray-600 hover:text-gray-800 text-sm py-2 px-4 rounded">{`See Next Project ${String.fromCharCode(8594)}`}</Link>
    </div>
  </div>
)
