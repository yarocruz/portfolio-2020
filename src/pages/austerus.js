...
import austerePic from "../images/austere.png";
    ...
    <div className="container text-gray-900 mx-auto mx-10 my-10">
      <div className="page p-5">
        <div className="flex items-center mb-5">
          <h1 className="secondary-heading pr-5">Austerus</h1>
          <div className="flex">
            <a href="https://github.com/yarocruz/austerus/tree/real-austerus">
            ...
            <a href="http://jayc1.sgedu.site/" target="_blank" rel="noopener noreferrer" className="ml-3">
        ...
        <img className="lg:max-w-3xl max-w-full mb-5 shadow" src={austerePic} alt="screenshot of austere website" />

        <p className="max-w-3xl my-5">Austerus is minimalist WordPress theme. It is meant to be a portfolio theme, but it can
        easily be adapted into any type of website. The purpose of this project is to showcase my skills in WordPress theme
        development.</p>

        <h1 className="secondary-heading pr-5">Technologies</h1>

        <p className="max-w-3xl my-5">WordPress runs on PHP and SQL. You use HTML withing HTML files to render data dynamically. Out the box
        WordPress has all the PHP files to get you up and running, and there's a whole ecosystem or 'framework' of of php WordPress
        functions that you can use to create a dynamic website.</p>

        <h1 className="secondary-heading pr-5">Problems and Solutions</h1>

        <p className="max-w-3xl my-5">WordPress is easy to get started with, but it has it's learning curve if you want to
        customize it. Once you start getting familiar with it's core PHP functions like the_post and now where to plug these in,
        you really start to appreciate it's power. Having a solid foundation in JavaScript, makes switching into PHP super easy.</p>
