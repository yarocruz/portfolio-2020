    ...
    <div className="page p-5">
      <div className="flex items-center mb-5">
        ...
        <div className="flex">
          ...
          <a href="https://yarocruz.github.io/react-employee-directory//code-quiz/" target="_blank" rel="noopener noreferrer" className="ml-3">
      ...
      <Link to="/poddler" className="shadow bg-gray-100 hover:bg-gray-300 focus:shadow-outline focus:outline-none text-gray-600 hover:text-gray-800 text-sm py-2 px-4 rounded">{`See Next Project ${String.fromCharCode(8594)}`}</Link>
    </div>
  </div>
)
