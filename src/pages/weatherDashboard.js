    ...
    <div className="container text-gray-900 mx-auto mx-10 my-10">
        <div className="page p-5">
            <div className="flex items-center mb-5">
                <h1 className="secondary-heading pr-5 text-blue-900">Weather Dashboard</h1>
                <div className="flex">
            ...
            <p className="max-w-3xl my-5">This is a web application that uses OpenWeatherMap's API. When the user types in a city name, they can hit enter or click the input search button and see the city's current weather. It specifically grabs the temperature,
            ...
            <p className="max-w-3xl my-5">This project was built with jQuery and Bootsrap, but the bulk of it consists of api calls to OpenWeatherMap.
            ...
            <p className="max-w-3xl my-5 pb-5">
                <code className="bg-gray-100 text-gray-600 p-3 max-w-full">
